...
function initPlayer() {
  ...
  listenForMetadata(streamManager);
...
/**
 * Initates stream playback and sets up the play button.
 */
function initiatePlayback() {
  Console.log('initiatePlayback');
  requestStream();
  playButton.style.display = 'none';
  playButton.removeEventListener('click', this);
 ...
 */
function createSteamManager() {
  streamManager =
      new google.ima.dai.api.StreamManager(videoElement, adUiElement);
  streamManager.addEventListener(
      google.ima.dai.api.StreamEvent.Type.LOADED, onStreamEvent, false);
  streamManager.addEventListener(
      google.ima.dai.api.StreamEvent.Type.ERROR, onStreamEvent, false);
  streamManager.addEventListener(
      google.ima.dai.api.StreamEvent.Type.AD_BREAK_STARTED, onStreamEvent, false);
  streamManager.addEventListener(
      google.ima.dai.api.StreamEvent.Type.AD_BREAK_ENDED, onStreamEvent, false);
}
 ...
 * @param {!google.ima.dai.api.StreamManager} streamManager
 */
function listenForMetadata(streamManager) {
